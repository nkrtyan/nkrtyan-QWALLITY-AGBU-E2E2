...
def analyze_results(directory_name, file_name):
    ...
    print(f"Number of examined students: {number_of_students}") # TODO, dont use print, instead you have logged info
...
# Nel, working code, keep one working version in the file
